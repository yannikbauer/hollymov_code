...
def get_all_tranges(key, include_spont=False):
    ...
    key : dict
        ...
        E.g., {'m': 'Ntsr1Cre_2019_0003', 's': 4, 'e': 9}
    include_spont: bool
        Optional include time ranges during gray screen (measuring spontaneous activity 60 s
        before and after the Hollywood movie is played).
    ...
    if include_spont == False:
        # only include tranges during movie presentation
        tranges_all = np.squeeze(tranges_all[
